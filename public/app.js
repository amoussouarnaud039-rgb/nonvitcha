...
function renderNavigation() {
    ...
    if (!currentUser) {
        nav.innerHTML = `
            <button class="nav-btn" onclick="showSection('auth-section')">Connexion / Inscription</button>
            <button class="nav-btn" onclick="showSection('ecoutes-section')">Écoute SOS / SSR</button>
            <button class="nav-btn" onclick="showSection('admin-section')">Admin</button>
        `;
    } else {
        nav.innerHTML = `
            <button class="nav-btn" onclick="showSection('members-section')"><i class="fa-solid fa-users"></i> Membres</button>
            <button class="nav-btn" onclick="showSection('public-chat-section')"><i class="fa-solid fa-comments"></i> Chat Public</button>
            <button class="nav-btn" onclick="showSection('recharge-section')"><i class="fa-solid fa-coins"></i> ${currentUser.coins || 0} Coins ${currentUser.isVip ? '👑 VIP' : ''}</button>
            <button class="nav-btn" onclick="showSection('ecoutes-section')"><i class="fa-solid fa-hand-holding-heart"></i> Écoute SOS</button>
            <button class="nav-btn" onclick="showSection('admin-section')">Admin</button>
            <button class="nav-btn" onclick="logout()" style="color:var(--primary-color);"><i class="fa-solid fa-power-off"></i> Déconnexion</button>
        `;
    }
}
...
// Coup de Cœur envoyé directement depuis la barre de chat
...
function triggerKkiaPay(amount) {
    ...
    openKkiapayWidget({
        ...
        callback: "",
        data: "",
        key: "public_key_here" // Remplacer par la clé publique KKiaPay
    });
}
